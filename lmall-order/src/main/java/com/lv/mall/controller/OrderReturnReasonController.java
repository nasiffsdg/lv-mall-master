...
import com.lv.mall.entity.OrderReturnReason;
import com.lv.mall.service.OrderReturnReasonService;
...
public class OrderReturnReasonController extends ApiController {
     ...
     */
    @GetMapping
    public R selectAll(Page<OrderReturnReason> page, OrderReturnReason orderReturnReason) {
     ...
     */
    @PostMapping
    public R insert(@RequestBody OrderReturnReason orderReturnReason) {
