...
import com.lv.mall.entity.OrderSetting;
import com.lv.mall.service.OrderSettingService;
...
public class OrderSettingController extends ApiController {
     ...
     */
    @GetMapping
    public R selectAll(Page<OrderSetting> page, OrderSetting orderSetting) {
     ...
     */
    @PostMapping
    public R insert(@RequestBody OrderSetting orderSetting) {
